...
const Footer = () => {
  ...
  return <footer className="bg-primary text-primary-foreground pt-16 pb-8" id="contact">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 mb-6">7-14 Nikunja Housing Society
Khulshi, Chattogram</p>
            <div className="flex items-center gap-4">
              <a href="https://facebook.com" className="w-10 h-10 bg-white/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors" aria-label="Facebook">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://youtube.com" className="w-10 h-10 bg-white/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors" aria-label="YouTube">
                <Youtube className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com" className="w-10 h-10 bg-white/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors" aria-label="LinkedIn">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://instagram.com" className="w-10 h-10 bg-white/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+880xxxxxxxxx" className="text-primary-foreground/80 hover:text-accent transition-colors">+880-18511-20791</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent flex-shrink-0" />
                <a href="mailto:info@pciu.edu" className="text-primary-foreground/80 hover:text-accent transition-colors">admission@portcity.edu.bd</a>
              </li>
            </ul>
            <p className="text-sm text-primary-foreground/60 mt-4">
              Office Hours: Sunday–Thursday<br />9:00 AM – 5:00 PM
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 mb-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input type="email" placeholder="Your email address" className="flex-1 px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-accent" aria-label="Email address" />
              <Button className="bg-highlight hover:bg-highlight/90 text-highlight-foreground font-semibold px-8">
                Subscribe
              </Button>
            </div>
